...
#define	CMD_ATT_RESET_FLGSET		6087	///< アッテネータリセットフラグS設定	// //V4.15.0.0
#define	CMD_TRIMDATA_OFFSET		    6088	///< ステップオフセットデータ送信		//V4.21.1.0①
#define	CMD_SPLASER_READYGET		6089	///< SP製レーザのReady信号アドレスの状態取得	// //V5.0.6.0①
#define CMD_SPLASER_EXTDIODESET		6090	///< SP製レーザのEXT-Diode出力をON/OFFする		// V5.0.6.0①
#define CMD_EXTVACUUM				6091	///< EXT吸着の使用有無設定				// V5.0.6.0①
...
//V4.21.2.0①↓
#define	CMD_STAGEZINIT				8050	///< 載物台Z軸初期化
#define	CMD_GETSTAGEZPOS			8051	///< 載物台Z位置取得
#define	CMD_STAGEZMOVE				8052	///< 載物台Z位置移動
#define	CMD_STAGEZPLSMOVE			8053	///< 載物台Zパルス指定移動
#define	CMD_STAGEZOFFSET			8054	///< 載物台Z軸原点オフセット設定
//V4.21.2.0①↑
#define CMD_STAGEZSENSOR			8055	///< 載物台Z軸高さセンサIO取得		//V5.0.5.0②
#define	CMD_GETSTAGEZPLS			8056	///< 載物台Zパルス取得
