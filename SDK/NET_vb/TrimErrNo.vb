...
#Region "エラーコードの定義"
    ...
    Public Const aaaa As Short = 5                                   ' XY軸同時指定
...
#Region "i-TKY系エラーコードの定義"
    ...
    Public Const cFRS_SHIFT As Short = 6                                ' Shiftキー押下でSTART　'V6.0.6.2①
    Public Const cFRS_ERR_NOP As Short = 9                              ' OcxJOGからの上記以外の戻り
    ...
    Public Const cFRS_ERR_RINGBLOW As Short = -62                       ' リングブロー異常      'V6.5.7.0④

    '----- V8.0.0.15①(OcxSystem)↓ -----
    '----- パラメータエラー等(メッセージ表示はしない) -----
    Public Const cFRS_ERR_CMD_NOTSPT As Short = -70                     ' 未サポートコマンド
    Public Const cFRS_ERR_CMD_PRM As Short = -71                        ' パラメータエラー
    Public Const cFRS_ERR_CMD_LIM_L As Short = -72                      ' パラメータ下限値エラー
    Public Const cFRS_ERR_CMD_LIM_U As Short = -73                      ' パラメータ上限値エラー
    Public Const cFRS_ERR_CMD_OBJ As Short = -74                        ' オブジェクト未設定(Utilityｵﾌﾞｼﾞｪｸﾄ他)
    Public Const cFRS_ERR_CMD_EXE As Short = -75                        ' コマンド実行エラー(DllTrimFncから99で返ってくるもの)
    ...
    Public Const cFRS_VACCUME_ERROR As Short = -100                     ' 吸着エラー
...
#Region "INtime側エラーコード定義"
    ...
    Public Const ERR_SOFTLIMIT_T As Short = 112                         ' THETA軸ソフトリミット '###801①
    ...
    Public Const ERR_INTERLOCK_STSCHG As Short = 212                    ' インターロック状態変更
    Public Const ERR_AXS_LIM As Short = 220                             ' 各軸のリミット検出(リミット到達中)

    Public Const ERR_AXS_HARD_ERROR As Short = 250                       ' ATT軸－リミット検出       'V6.5.7.0③
    Public Const ERR_PROBE_UP_ERROR As Short = 251                      ' プローブユニット上昇エラー       'V6.5.7.0③
    Public Const ERR_PROBE_DOWN_ERROR As Short = 252                    ' プローブユニット下降エラー      'V6.5.7.0③
    Public Const ERR_AXS_PLUS_LIM As Short = 253                        ' ATT軸＋リミット検出       'V6.5.7.0③
    Public Const ERR_AXS_MINUS_LIM As Short = 254                       ' ATT軸－リミット検出       'V6.5.7.0③
